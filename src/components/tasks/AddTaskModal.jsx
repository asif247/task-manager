...
const AddTaskModal = ({isOpen,setIsOpen}) => {
    ...
    return (
        <>
        <Modal isOpen={isOpen} setIsOpen={setIsOpen} title="Task Form">
        ...
        <div className="flex flex-col mb-5">
          ...
          <select
            ...
            {...register('assignedTo')}
          >
            <option value="Mir Hussain">Ashikur Rahman Asif</option>
            <option value="Mezba Abedin">Ruhul Amin Sabbir</option>
            <option value="Nahid Hasan">Aktaruzzaman Razib</option>
